...
console.log(devolverPrimerElemento([2,2,3]));
...
const crearInstanciaPersona = (nombre, apellido, edad, dir)=>{
    ...
    const personita = new Persona ("Juan", "Perez", 22, "Saavedra 123" );
    return personita;
...
const copiarEach = (array, cb) =>{
  ...
  function filter(array) {
    ...
    //Tu código:
    const nuevo = array.filter(array => array.substring(0,1) == 'a')
    return nuevo;   
  } 
